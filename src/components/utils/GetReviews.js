...
const GetReview = () => {
  ...
  const { id, timeStamp, name, fullName, ratings, feedback } =
    loadedReviews[index];
    ...
    <Container>
      <div className="review-card" key={id}>
        <div className="review-content">
          ...
          <div>
            <span className="btn_prev" onClick={prevPerson}>
              ◀
            </span>
            <span className="btn_nxt" onClick={nextPerson}>
              ▶
            </span>
          </div>
      ...
      <div className="review_btn_div">
        <button className="review_btn" onClick={() => navigate("/PostReviews")}>
          Give Reviews😊
        </button>
      </div>
    </Container>
